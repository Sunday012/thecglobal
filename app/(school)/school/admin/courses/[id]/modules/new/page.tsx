...
export default async function NewModulePage({ params }: NewModulePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white w-full to-blue-50/20">
      {/* Modern Header */}
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-[#272f31] mb-2">Create New Module</h1>
              <p className="text-lg text-gray-600">
                Add a new module to: <span className="font-semibold text-[#0A523B]">{course.title}</span>
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-white/80 mt-2">
                  {course.duration_weeks} weeks • Module {nextOrderIndex}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <ModuleForm courseId={id} defaultOrderIndex={nextOrderIndex} />
      </main>
    </div>
  )
}