...
export default function Header({ isHomePage = false }) {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          ...
          <div className={`flex flex-col sm:flex-row rounded-4xl px-2 sm:px-4 py-4 items-center justify-between ${
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              {/* <Button className={`hover:bg-[#0A523B]/80 font-work-sans font-medium px-4 sm:px-6 py-2 rounded-full text-xs sm:text-sm tracking-wide transition-all duration-500 ${
      ...
      >
        {/* Menu Header */}
        <div className="flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6 lg:p-8 gap-4 sm:gap-0">
          {/* Logo and Search */}
          <div className="flex items-center space-x-4 sm:space-x-8 w-full sm:w-auto">
            ...
            <div className="relative hidden sm:block">
              ...
              <Input
                ...
                className="bg-transparent border border-gray-600 text-white placeholder:text-gray-400 pl-10 pr-4 py-2 rounded-md w-64 lg:w-80"
              />
            </div>
          </div>
          ...
          {/* Mobile search input */}
          <div className="w-full block sm:hidden mt-2">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
              <Input
                placeholder="Search Encounter"
                className="bg-transparent border border-gray-600 text-white placeholder:text-gray-400 pl-10 pr-4 py-2 rounded-md w-full"
              />
            </div>
          </div>
        </div>
        ...
        {/* Menu Content */}
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 h-[calc(100vh-120px)] overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            {/* Church Title and Tagline */}
            <div className="mb-8 sm:mb-12">
              <h1 className="text-2xl sm:text-4xl lg:text-5xl font-rubik font-bold text-white mb-2 sm:mb-4">The Encounter Center Church</h1>
              <p className="text-base sm:text-xl text-gray-300 font-work-sans">For God. For People. For the City. For the World.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 mb-10 sm:mb-16">
              {/* Our House */}
              <div>
                <h3 className="text-gray-400 font-work-sans text-xs sm:text-sm uppercase tracking-wide mb-4 sm:mb-6">Our House</h3>
              ...
              {/* Locations */}
              <div>
                <h3 className="text-gray-400 font-work-sans text-xs sm:text-sm uppercase tracking-wide mb-4 sm:mb-6">Locations</h3>
                <ul className="space-y-2 sm:space-y-4">
                  <li>
                    <Link
                      href="/houston"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
              {/* Featured Event Card */}
              <div className="bg-gradient-to-r from-[#0A523B] to-[#FAE8A1] rounded-2xl p-4 sm:p-8 relative overflow-hidden">
                <div className="relative z-10">
                  <p className="text-white/80 font-work-sans text-xs sm:text-sm uppercase tracking-wide mb-1 sm:mb-2">UPCOMING EVENT</p>
                  <h4 className="text-xl sm:text-3xl font-rubik font-bold text-white mb-2 sm:mb-4">Encounter 2026</h4>
                  <p className="text-white/90 font-work-sans text-base sm:text-lg mb-4 sm:mb-6">January 13, 2026</p>
                  <Button className="bg-white text-[#0A523B] hover:bg-white/90 font-work-sans font-medium px-4 sm:px-6 py-2 sm:py-3 rounded-full text-xs sm:text-sm tracking-wide">
                    LEARN MORE
                  </Button>
                </div>
              </div>
              ...
              <div className="flex flex-col items-start mt-6 lg:mt-0">
                <h4 className="text-gray-400 font-work-sans text-xs sm:text-sm uppercase tracking-wide mb-4 sm:mb-6">Connect With Us</h4>
