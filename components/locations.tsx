          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8">
            <div className="relative group cursor-pointer">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8">
                  <h3 className="text-white font-rubik font-bold text-2xl sm:text-3xl md:text-4xl">Houston</h3>
                  <p className="text-white/80 font-work-sans text-base sm:text-lg mt-1 sm:mt-2">15000 Bellaire Blvd Unit W</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8">
                  <h3 className="text-white font-rubik font-bold text-2xl sm:text-3xl md:text-4xl">Springfield</h3>
